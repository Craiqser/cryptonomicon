...
export default {
	...
	methods: {
		...
		tickerDelete(tickerToDelete) {
			this.tickers = this.tickers.filter(t => t.name !== tickerToDelete.name);
		}
	}
}
</script>
	...
	<div class="container">
			...
			<div class="flex">
				<div class="max-w-xs">
					...
					<div class="mt-1 relative rounded-md shadow-md">
						<input v-model='ticker' @keydown.enter='tickerAdd'
		...
		<template v-if='tickers.length'>
			...
			<dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
				<div v-for="t in tickers" :key="t.name" class="bg-white overflow-hidden shadow rounded-lg border-purple-800 border-solid cursor-pointer">
